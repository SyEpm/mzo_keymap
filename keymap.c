...
qk_tap_dance_action_t tap_dance_actions [] = {
    [TD_SPC_ENT] = ACTION_TAP_DANCE_DOUBLE (KC_SPC, KC_ENT),    // 1 toque- ESPACIO, 2 toques- ENTER
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 TD(TD_SFT_CAP),    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                         KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_RSFT,
    ...
    //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                    TD(TD_ALT_GUI), MO(_NUMER), KC_BSPC, TD(TD_SPC_ENT), MO(_MOVIM),  KC_DEL
                                        //|--------------------------|  |--------------------------|
  ),

  [_DVORAK] = LAYOUT_split_3x6_3(
    //,-----------------------------------------------------|                    |-----------------------------------------------------|
         KC_TAB,  KC_DOT, KC_COMM, KC_SCLN,    KC_P,    KC_Y,                         KC_F,    KC_G,    KC_C,    KC_H,    KC_L, KC_LBRC,
    //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
 TD(TD_SFT_CAP),    KC_A,    KC_O,    KC_E,    KC_U,    KC_I,                         KC_D,    KC_R,    KC_T,    KC_N,    KC_S, KC_RSFT,
  ...
  [_NUMER] = LAYOUT_split_3x6_3(
    ...
    //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                            KC_LALT, KC_TRNS,  KC_SPC,    KC_ENT, MO(_AJUSTE), KC_RALT
                                        //|--------------------------|  |--------------------------|
  ),
  ...
  [_MOVIM] = LAYOUT_split_3x6_3(
    ...
    //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          KC_BTN2, MO(_AJUSTE), KC_BTN1,  KC_BTN3, KC_TRNS,  KC_DEL
                                        //|--------------------------|  |--------------------------|
  ),
